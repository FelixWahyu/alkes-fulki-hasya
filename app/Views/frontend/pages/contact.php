    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-5 reveal">
                ...
                <h2 style="font-size:1.75rem; font-weight:800; margin-bottom:8px; margin-top:12px;">Hubungi Kami
                    Langsung</h2>
                ...
                <div class="contact-cards">
                    <div class="contact-card">
                        ...
                        <div class="contact-card-body">
                            <h6>Alamat Toko</h6>
                            <p><?= esc($settings['web_address'] ?? 'Jl. Kesehatan Raya No. 123, Indonesia') ?></p>
                        </div>
                    </div>
                    ...
                    <div class="contact-card">
                        ...
                        <div class="contact-card-body">
                            <h6>Email Resmi</h6>
                            <a target="_blank"
                                href="https://mail.google.com/mail/?view=cm&fs=1&to=<?= $settings['web_email'] ?? 'info@fulkihasya.com' ?>"
                                class="contact-link"><?= $settings['web_email'] ?? 'info@fulkihasya.com' ?></a>
                        </div>
                    </div>
                ...
                <!-- Social Media -->
                <div class="mt-4">
                    <p style="font-size:0.85rem; font-weight:700; color:var(--fh-text); margin-bottom:14px;">Ikuti
                        Kami di Media Sosial</p>
                ...
                <div class="map-wrap card-fh p-0 overflow-hidden">
                    ...
                    <div class="map-footer">
                        ...
                        <a href="https://goo.gl/maps/example" target="_blank"
                            style="color:var(--fh-primary); font-weight:600; text-decoration:none; font-size:0.88rem;">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="card-fh p-0 overflow-hidden reveal">
                    <div class="row g-0">
                        <div
                            class="col-lg-5 p-4 p-md-5 bg-primary text-white d-flex flex-column justify-content-center">
                            ...
                            <p class="mb-4 opacity-75">Kami selalu terbuka untuk peluang kerjasama baru yang saling
                                menguntungkan. Silakan isi data perusahaan Anda.</p>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <small class="opacity-75">Kerahasiaan data perusahaan Anda adalah prioritas
                                        kami.</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-7 p-4 p-md-5 bg-white">
                                ...
                                <div class="alert alert-success border-0 rounded-4 p-4 mb-4"
                                    ...
                                    <div class="d-flex gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="small mb-0">Terima kasih atas minat Anda untuk bekerjasama. Tim kami
                                                akan segera menghubungi Anda melalui email atau nomor telepon yang
                                                diberikan.</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form action="<?= base_url('partnership/submit') ?>" method="POST" id="partnershipForm">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <label class="form-label fw-bold small text-muted text-uppercase">Nama Mitra /
                                            Perusahaan</label>
                                        <input type="text" name="company_name"
                                            class="form-control bg-light border-0 py-3 px-4"
                                            placeholder="Contoh: PT. Sehat Sentosa" required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold small text-muted text-uppercase">Nomor Telepon
                                            / WA</label>
                                        <input type="tel" name="phone" class="form-control bg-light border-0 py-3 px-4"
                                            placeholder="0812xxxxxx" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label fw-bold small text-muted text-uppercase">Pesan
                                            Kerjasama</label>
                                        <textarea name="message" class="form-control bg-light border-0 py-3 px-4"
                                            rows="4"
                                            placeholder="Jelaskan secara singkat rencana atau bentuk kerjasama yang Anda tawarkan..."
                                            required></textarea>
                                    </div>
                                    <div class="col-md-12 pt-2">
                                        <button type="submit"
                                            class="btn btn-primary w-100 py-3 fw-bold rounded-3 shadow-primary">
        ...
        <div class="contact-cta-banner">
            <div class="row align-items-center g-4">
                <div class="col-lg-8">
                    ...
                    <p style="color:rgba(255,255,255,0.8); margin:0;">Chat langsung dengan admin kami untuk mendapatkan
                        informasi stok, harga, dan konsultasi produk secara gratis.</p>
                </div>
                <div class="col-lg-4 text-lg-end">
                    <a href="https://wa.me/<?= $settings['wa_number'] ?? '' ?>" target="_blank" class="cta-wa-btn">
