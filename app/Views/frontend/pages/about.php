        ...
        <div class="row g-4">
            ...
            <div class="col-md-6 reveal reveal-delay-1">
                <div class="visi-misi-card visi">
                    ...
                    <h3>Visi Kami</h3>
                    <p>Menjadi penyedia alat kesehatan terlengkap, terpercaya, dan menjadi solusi utama bagi peningkatan
                        kualitas hidup masyarakat Indonesia melalui teknologi medis unggul.</p>
                </div>
            </div>
            ...
            <div class="col-md-6 reveal reveal-delay-2">
                <div class="visi-misi-card misi">
                    ...
                    <h3>Misi Kami</h3>
                    <ul class="misi-list">
                        <li><i class="fas fa-check"></i> Menyediakan alat kesehatan yang tersertifikasi dan berkualitas
                            tinggi.</li>
                        <li><i class="fas fa-check"></i> Memberikan layanan konsultasi dan purna jual yang profesional.
                        </li>
                        <li><i class="fas fa-check"></i> Membangun kemitraan strategis dengan produsen medis terkemuka
                            global.</li>
            ...
            foreach ($values as $i => $v): ?>
                <div class="col-sm-6 col-lg-3 reveal reveal-delay-<?= $i + 1 ?>">
                    <div class="value-card card-fh p-4 h-100">
                        ...
                        <p style="font-size:0.88rem; color:var(--fh-text-muted); line-height:1.7; margin:0;">
                            <?= $v['desc'] ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
...
<style>
    ...
    .visi-misi-card.visi .visi-misi-icon {
