...
<head>
    ...
    <meta name="description" content="<?= $meta_desc ?? 'Toko Alat Kesehatan Fulki Hasya - Penyedia peralatan medis berkualitas untuk rumah sakit, klinik, dan kebutuhan pribadi. Produk lengkap, harga kompetitif, terpercaya.' ?>">
    <meta name="keywords" content="alat kesehatan, alkes, peralatan medis, tensimeter, oksimeter, nebulizer, kursi roda, Fulki Hasya">
    ...
    <meta property="og:description" content="<?= $meta_desc ?? 'Penyedia peralatan medis berkualitas untuk rumah sakit, klinik, dan kebutuhan pribadi.' ?>">
    ...
    <style>
        ...
        :root {
            ...
            --fh-primary:        #1D4ED8; /* Core brand blue */
            --fh-primary-dark:   #1E3A8A; /* Deep navy */
            --fh-primary-light:  #3B82F6; /* Light blue */
            --fh-accent:         #38BDF8; /* Sky accent */
            --fh-white:          #FFFFFF;
            --fh-off-white:      #F8FAFF; /* Near-white with blue tint */
            --fh-text:           #0F172A; /* Near-black */
            --fh-text-muted:     #64748B; /* Slate */
            --fh-border:         #E2E8F0;
            --fh-success:        #10B981;
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        a { transition: color var(--fh-transition); }
        ...
        /* ---- Section ---- */
        .section-fh { padding: 80px 0; }
        .section-fh-sm { padding: 56px 0; }
        .section-bg-light { background: var(--fh-off-white); }
        ...
        #mainNav.nav-transparent .navbar-brand { color: #fff !important; }
        #mainNav.nav-transparent .nav-link:hover { color: #fff !important; }
        #mainNav.nav-transparent .hamburger span { background: #fff; }
        ...
        #mainNav.nav-solid .nav-link { color: var(--fh-text) !important; }
        #mainNav.nav-solid .navbar-brand { color: var(--fh-primary) !important; }
        #mainNav.nav-solid .hamburger span { background: var(--fh-primary); }
        ...
        #mainNav.nav-transparent .nav-link-fh::after { background: rgba(255,255,255,0.8); }
        .nav-link-fh:hover::after, .nav-link-fh.active-link::after { width: 100%; }
        .nav-link-fh.active-link { color: var(--fh-primary-light) !important; }
        #mainNav.nav-transparent .nav-link-fh.active-link { color: #fff !important; }
        ...
        @media (max-width: 991.98px) {
            ...
            .navbar-collapse-fh.open { transform: translateX(0); }
            ...
            .mobile-nav-links .nav-link-fh:last-child { border-bottom: none; }
            .mobile-nav-links .nav-link-fh::after { display: none; }
            .mobile-nav-close {
                position: absolute;
                top: 16px;
                right: 16px;
        ...
        @media (min-width: 992px) {
            .navbar-collapse-fh { display: flex !important; align-items: center; }
            .navbar-collapse-fh.open { transform: none !important; }
        }
        ...
        .footer-fh p { color: rgba(255,255,255,0.65); font-size: 0.9rem; line-height: 1.75; }
        .footer-heading {
            font-size: 0.75rem;
            font-weight: 700;
            letter-spacing: 2px;
        ...
        .footer-link:hover { color: var(--fh-accent); padding-left: 6px; }
        .footer-social {
            display: inline-flex;
            align-items: center;
            justify-content: center;
        ...
        .footer-social:hover { background: var(--fh-accent); color: #fff; transform: translateY(-2px); }
        .footer-bottom {
        ...
        .float-wa:hover { transform: scale(1.1); color: #fff; box-shadow: 0 10px 40px rgba(37,211,102,0.55); }
        @keyframes waPulse {
        ...
        /* ============================================================
           UTILITIES
           ============================================================ */
        .text-primary-fh { color: var(--fh-primary); }
        .bg-blue-50 { background: var(--fh-blue-50); }
        ...
        @media (max-width: 575.98px) {
            .section-fh { padding: 56px 0; }
            .section-fh-sm { padding: 40px 0; }
        }
    </style>
</head>
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <div class="navbar-collapse-fh" id="navCollapse">
            ...
            <div class="mobile-nav-links d-flex flex-column flex-lg-row align-items-lg-center gap-lg-4 ms-lg-auto">
                ...
                ?>
                    <a href="<?= base_url($uri) ?>"
                       class="nav-link-fh <?= $isActive ? 'active-link' : '' ?>">
                        <?= $label ?>
                    </a>
                <?php endforeach; ?>
            </div>
...
<footer class="footer-fh">
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer-logo-text">
                    <i class="fas fa-heartbeat me-2" style="color: var(--fh-accent);"></i>Fulki Hasya
                </div>
                <p><?= $settings['about_text'] ?? 'Penyedia peralatan medis berkualitas untuk rumah sakit, klinik, dan kebutuhan pribadi.' ?></p>
                <div class="mt-4">
                    <a href="https://wa.me/<?= $settings['wa_number'] ?? '' ?>" target="_blank" class="footer-social" aria-label="WhatsApp">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="d-flex gap-3 mb-3">
                    <div class="icon-box" style="background:rgba(255,255,255,0.07); color:var(--fh-accent); width:38px; height:38px; min-width:38px; border-radius:8px;">
                        <i class="fab fa-whatsapp" style="font-size:16px;"></i>
                    </div>
                    <div>
                        <div style="font-size:0.78rem; color:rgba(255,255,255,0.4); margin-bottom:2px;">WhatsApp</div>
                        <span style="font-size:0.88rem; color:rgba(255,255,255,0.8);">+<?= $settings['wa_number'] ?? '62-xxx-xxxx-xxxx' ?></span>
                    </div>
                </div>
                <div class="d-flex gap-3">
                    ...
                    <div>
                        ...
                        <span style="font-size:0.88rem; color:rgba(255,255,255,0.8);">Indonesia</span>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-bottom d-flex flex-column flex-md-row align-items-center justify-content-between gap-2">
            <p>&copy; <?= date('Y') ?> Toko Alat Kesehatan Fulki Hasya. Semua hak dilindungi.</p>
...
<!-- Floating WhatsApp -->
<a href="https://wa.me/<?= $settings['wa_number'] ?? '' ?>" class="float-wa" target="_blank" aria-label="Chat via WhatsApp">
    <i class="fab fa-whatsapp"></i>
</a>
